    ...
    <div className="flex flex-col items-center justify-center min-h-[60vh] px-4">
      <div className="text-center space-y-6 max-w-sm">
        ...
        <button
          onClick={signIn}
          disabled={!canSignIn}
          className="w-full flex items-center justify-center gap-2.5 px-4 py-3 rounded-xl bg-white hover:bg-gray-100 disabled:opacity-50 disabled:cursor-not-allowed text-gray-800 font-medium text-sm transition-colors shadow"
        >
      ...
      <SheetPickerDialog open={sheetPickerOpen} onClose={() => setSheetPickerOpen(false)} />
    </div>
  );
}
