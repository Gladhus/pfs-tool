...
export const I18N = {
  fr: {
    ...
    new_prefilled: (d) => `Nouveau — pré-rempli du ${d}`,
    new_date: 'Nouvelle date',
    migrate_daily_title: 'Migrer vers le format journalier',
    migrate_daily_hint: 'Convertit les anciennes entrées mensuelles (AAAA-MM) en format journalier (AAAA-MM-01). À exécuter une seule fois.',
    migrate_daily_btn: 'Lancer la migration',
    migrate_daily_ok: (n) => `${n} ligne(s) migrée(s).`,
    migrate_daily_none: 'Aucune entrée mensuelle trouvée.',
  ...
  en: {
    ...
    new_prefilled: (d) => `New — pre-filled from ${d}`,
    new_date: 'New date',
    migrate_daily_title: 'Migrate to daily format',
    migrate_daily_hint: 'Convert old monthly entries (YYYY-MM) to daily format (YYYY-MM-01). Run once after updating the app.',
    migrate_daily_btn: 'Run migration',
    migrate_daily_ok: (n) => `${n} row(s) migrated.`,
    migrate_daily_none: 'No monthly entries found.',
